...
def preprocess(args):
    train_persona, train_query, train_response = read_convai2_split(args.trainset, multi_turn=args.multi_turn, shuffle=args.shuffle) if args.dataset_type=='convai2' else read_ecdt2019_split(args.trainset, split_type='train')
    ...
    if args.dataset_type=='convai2':
        ...
        if args.shuffle != -1:
            path = f'./data/ConvAI2/shuffle/convai2_tokenized_multi_turn_segtoken_shuffle_{args.shuffle}/'
    else:
